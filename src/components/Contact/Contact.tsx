      ...
      <div className="max-w-7xl mx-auto px-4 py-24">
        ...
        >
          ...
          <p className="text-blue-700/70 max-w-2xl mx-auto">
            Have questions about our flooring solutions? Get in touch with our
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <form
              ...
              className="bg-white shadow-lg backdrop-blur-lg p-8 rounded-2xl border border-blue-100"
            >
                  ...
                  >
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-blue-50/50 border border-blue-100 rounded-lg
                                                       ...
                                                       focus:ring-sky-400 focus: outline-none transition-all duration-300"
          ...
          >
            ...
            >
              ...
              <p className="mb-4 text-blue-100">
                Visit us to explore our flooring options and speak with our
                experts in person.
              </p>
              <motion.a
