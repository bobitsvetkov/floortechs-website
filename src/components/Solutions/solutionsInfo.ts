...
export const flooringSolutions: FlooringSolution[] = [
    {
      ...
      description: "Transform ordinary concrete into a stunning, high-performance surface with our mechanical polishing system. This solution densifies and polishes existing concrete to create a beautiful, durable floor with excellent light reflectivity and minimal maintenance requirements. Perfect for facilities seeking long-term sustainability with architectural appeal.",
      idealFor: [
        { 
